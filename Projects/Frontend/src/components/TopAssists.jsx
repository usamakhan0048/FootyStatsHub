  ...
  const fetchTopAssists = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `https://v3.football.api-sports.io/players/topassists?league=${selectedLeague}&season=${selectedSeason}`,
        {
          method: 'GET',
          headers: myHeaders,
          redirect: 'follow'
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-8">
            <div className="text-center">
              <h1 className="text-4xl font-bold text-white mb-2">Top Assists</h1>
            </div>
              ...
              <div className="rounded-2xl overflow-hidden bg-white/5 backdrop-blur-sm border border-purple-500/10">
                {loading ? (
                  ...
                  <table className="w-full">
                    ...
                    <tbody>
                      {topAssists.map(({ player, statistics }, index) => (
